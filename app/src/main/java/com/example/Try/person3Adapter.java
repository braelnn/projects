...
public class person3Adapter extends  FirebaseRecyclerAdapter<
        person3, person3Adapter.personssViewholder> {

    public person3Adapter(
            @NonNull FirebaseRecyclerOptions<person3> options)
    {
        super(options);
    }
    ...
    onBindViewHolder(@NonNull personssViewholder holder,
                     int position, @NonNull person3 model)
    {
                       ...
                       int viewType)
    {
        ...
        return new person3Adapter.personssViewholder(view);
    }
